 ...
 <Flex 
      ...
      <Box
        ...
        />
           ...
           <Center mt='5%' >
             <Flex  w='600px' h='400px' bgPosition="center" bg='#dddddd' direction='column'>
             <Stack spacing={3} direction='row'>
                  <Text fontSize='20px' w='150px' m='15px'>User Name</Text>
                  <Input variant='flushed' w='400px'  isInvalid errorBorderColor='#AA8B56'/>
             </Stack>
             <Stack spacing={3} direction='row'>
                  <Text fontSize='20px' w='150px' m='15px'>Frist Name</Text>
                  <Input variant='flushed' w='400px'isInvalid errorBorderColor='#AA8B56' />
             </Stack>
             <Stack spacing={3} direction='row'>
                  <Text fontSize='20px' w='150px' m='15px' >Last Name</Text>
                  <Input variant='flushed' w='400px' isInvalid errorBorderColor='#AA8B56' />
             </Stack>
             <Stack spacing={3} direction='row'>
                  <Text fontSize='20px' w='150px' m='15px'>Phone Number</Text>
                  <Input variant='flushed' w='400px' isInvalid errorBorderColor='#AA8B56'/>
             </Stack>
             <Stack spacing={3} direction='row'>
